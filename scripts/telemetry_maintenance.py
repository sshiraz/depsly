"""Run telemetry report publishing and retention cleanup together."""
...
from core.telemetry_aggregate import cleanup_telemetry_report_artifacts, write_telemetry_report_bundle
from core.telemetry_ingest import prune_stored_telemetry_events


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Publish telemetry reports and apply retention cleanup."
    )
    parser.add_argument(
        "--db-path",
        type=Path,
    ...
    parser.add_argument(
        ...
        help="Directory to receive and retain telemetry report artifacts.",
    )
    parser.add_argument(
        "--report-date",
